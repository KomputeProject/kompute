...
static const char* __doc_kp_Manager_destroy =
  R"doc(Destroy the GPU resources and all managed resources by manager.)doc";
...
static const char* __doc_kp_Sequence =
  R"doc(Container of operations that can be sent to GPU as batch)doc";
...
static const char* __doc_kp_Shader =
  R"doc(Shader utily class with functions to compile and process glsl files.)doc";
...
static const char* __doc_kp_Tensor_TensorTypes_eDevice =
  R"doc(< Type is device memory, source and destination)doc";

static const char* __doc_kp_Tensor_TensorTypes_eHost =
  R"doc(< Type is host memory, source and destination)doc";

static const char* __doc_kp_Tensor_TensorTypes_eStorage =
  R"doc(< Type is Device memory (only))doc";

static const char* __doc_kp_Tensor_allocateBindMemory = R"doc()doc";

static const char* __doc_kp_Tensor_allocateMemoryCreateGPUResources =
  R"doc()doc";
