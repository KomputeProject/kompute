...
#include <dlfcn.h>
    ...
    int InitVulkan(void)
    {
        ...
        vkCreateDevice = reinterpret_cast<PFN_vkCreateDevice>(
          dlsym(libvulkan, "vkCreateDevice"));
        ...
        vkCreateBuffer = reinterpret_cast<PFN_vkCreateBuffer>(
          dlsym(libvulkan, "vkCreateBuffer"));
        ...
        vkCreateImage = reinterpret_cast<PFN_vkCreateImage>(
          dlsym(libvulkan, "vkCreateImage"));
        vkDestroyImage = reinterpret_cast<PFN_vkDestroyImage>(
          dlsym(libvulkan, "vkDestroyImage"));
        ...
        vkCmdDraw =
          reinterpret_cast<PFN_vkCmdDraw>(dlsym(libvulkan, "vkCmdDraw"));
        ...
        vkCmdCopyImage = reinterpret_cast<PFN_vkCmdCopyImage>(
          dlsym(libvulkan, "vkCmdCopyImage"));
        vkCmdBlitImage = reinterpret_cast<PFN_vkCmdBlitImage>(
          dlsym(libvulkan, "vkCmdBlitImage"));
        ...
        vkGetPhysicalDeviceSparseImageFormatProperties2KHR = reinterpret_cast<
          PFN_vkGetPhysicalDeviceSparseImageFormatProperties2KHR>(dlsym(
          libvulkan, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR"));
        ...
        vkGetPhysicalDeviceExternalSemaphorePropertiesKHR = reinterpret_cast<
          PFN_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR>(dlsym(
          libvulkan, "vkGetPhysicalDeviceExternalSemaphorePropertiesKHR"));
        ...
        vkCmdDrawIndirectCountKHR =
          reinterpret_cast<PFN_vkCmdDrawIndirectCountKHR>(
        ...
        vkGetPhysicalDeviceWaylandPresentationSupportKHR = reinterpret_cast<
